...
describe('ModelDownloader — the vision folder', () => {
  ...
  it('refuses to fetch a folder copy of a model that is already installed flat', async () => {
    // Probed on b10665: with both `A-Q8_0.gguf` and `A-Q8_0/A-Q8_0.gguf` in the
    // models dir, only the FLAT one was served. The folder copy would be
    // gigabytes spent on a model the engine never lists.
