...
// The 'regenerateTopicCache — mtime preservation' describe block was removed in
// sync-legacy-demolition along with the regenerateTopicCache() method (it only
// ran inside the now-deleted pull() orchestrator).
