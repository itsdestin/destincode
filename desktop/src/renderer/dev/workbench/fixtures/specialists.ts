...
export function specialistRoster(): SpecialistDefinitionView[] {
  return [
    {
      id: 'explorer', displayName: 'Explorer', source: 'builtin', grantScope: 'builtin', charter: 'read-only',
    ...
    {
      id: 'researcher', displayName: 'Researcher', source: 'builtin', grantScope: 'builtin', charter: 'read-only',
      description: 'Web-heavy research with sourced summaries.',
      allowedTools: ['Read', 'Glob', 'Grep', 'WebFetch', 'WebSearch'], warnings: [], offered: true,
    },
    {
      id: 'reviewer', displayName: 'Reviewer', source: 'builtin', grantScope: 'builtin', charter: 'read-only',
    ...
    {
      id: 'worker', displayName: 'Worker', source: 'builtin', grantScope: 'builtin', charter: 'read-write',
    ...
    {
      id: 'docs-writer', displayName: 'Docs Writer', source: 'personal', grantScope: 'user', charter: 'read-write',
    ...
    },
    {
      ...
      id: 'release-checker', displayName: 'Release Checker', source: 'claude-code', grantScope: 'project', charter: 'read-only',
    ...
    {
      id: 'code-reviewer', displayName: 'code-reviewer', source: 'claude-code', grantScope: 'user', charter: 'read-only',
