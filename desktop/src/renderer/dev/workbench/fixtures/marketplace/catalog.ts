...
export const CATALOG_META: Record<string, CatalogMeta> = {
  ...
  'notion': {
    ...
    origin: { tier: 'verified', mirroredFrom: OFFICIAL },
    scan: CHECKED,
    capabilities: [net('api.notion.com'), key('NOTION_TOKEN', 'Notion'), adds('Adds 6 commands and 1 tool')],
  ...
  'browser-use': {
    ...
    capabilities: [shell('Runs a helper program on your computer'), net('any website'), key('BROWSER_USE_API_KEY', 'Browser Use'), adds('Adds 1 tool')],
    license: 'MIT', sourceCommit: '1f2e3d4',
  },
  'synthflow': { itemType: 'plugin', origin: { tier: 'community', mirroredFrom: OFFICIAL }, scan: UNCHECKED, capabilities: [net('api.synthflow.ai'), key('SYNTHFLOW_API_KEY', 'Synthflow'), adds('Adds 2 skills and 1 tool')], license: 'MIT' },
  'aiven': { itemType: 'plugin', origin: { tier: 'community', mirroredFrom: OFFICIAL }, scan: UNCHECKED, capabilities: [net('api.aiven.io'), key('AIVEN_TOKEN', 'Aiven'), adds('Adds 1 skill and 1 tool')], license: 'Apache-2.0' },
  ...
  'azure': { itemType: 'plugin', origin: { tier: 'verified', mirroredFrom: OFFICIAL }, scan: UNCHECKED, capabilities: [net('management.azure.com'), shell('Runs the Azure command-line tool'), adds('Adds 28 skills and 1 tool')], license: 'MIT' },
  'cloudflare': {
    itemType: 'plugin',
    origin: { tier: 'verified', mirroredFrom: OFFICIAL },
    scan: CHECKED,
    capabilities: [net('api.cloudflare.com'), key('CLOUDFLARE_API_TOKEN', 'Cloudflare'), adds('Adds 13 skills, 2 commands and 1 tool')],
    license: 'Apache-2.0', sourceCommit: '7c8d9e0',
  },
  'adobe-for-creativity': { itemType: 'plugin', origin: { tier: 'community', mirroredFrom: OFFICIAL }, scan: UNCHECKED, capabilities: [net('firefly-api.adobe.io'), key('ADOBE_CLIENT_ID', 'Adobe'), adds('Adds 7 skills and 1 tool')] },
