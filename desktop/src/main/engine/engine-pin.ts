...
export const ENGINE_ASSETS: EngineAsset[] = [
  ...
  { platform: 'darwin', arch: 'arm64', backend: 'metal', assetName: 'llama-b9992-bin-macos-arm64.tar.gz', sha256: 'b6021d0d6f87d58514d92a67c6fe2956638c242fc2aa30a11c370645246b90a0', binaryRelPath: 'build/bin/llama-server' },
  { platform: 'darwin', arch: 'x64', backend: 'metal', assetName: 'llama-b9992-bin-macos-x64.tar.gz', sha256: '7a632870b57fc260b2a978404efa8655c427e9433c95b6596b832507991a4389', binaryRelPath: 'build/bin/llama-server' },
  { platform: 'linux', arch: 'x64', backend: 'vulkan', assetName: 'llama-b9992-bin-ubuntu-vulkan-x64.tar.gz', sha256: 'cbc3e4928018d0b2b61af8bba22dfe097bfd487ae51184dfa00dc0330f0a3a7b', binaryRelPath: 'build/bin/llama-server' },
  { platform: 'linux', arch: 'x64', backend: 'cpu', assetName: 'llama-b9992-bin-ubuntu-x64.tar.gz', sha256: 'a56a9c6c971a36be3b2045fdf458d2fae88700883931c94eb214dff4e19165d9', binaryRelPath: 'build/bin/llama-server' },
  { platform: 'linux', arch: 'arm64', backend: 'vulkan', assetName: 'llama-b9992-bin-ubuntu-vulkan-arm64.tar.gz', sha256: '0ff433609ac0ff624e50ae5eb386a56f5989b8b4e86e4b56967200346bac35c8', binaryRelPath: 'build/bin/llama-server' },
  { platform: 'linux', arch: 'arm64', backend: 'cpu', assetName: 'llama-b9992-bin-ubuntu-arm64.tar.gz', sha256: '211bc659fa49ac96b311fe41c6249dd29e133654cf48389556845caecb3dd2a6', binaryRelPath: 'build/bin/llama-server' },
];
